...
def get_dataset(list_dir = "aesthetics_image_lists"):
	...
	for listfile_name in os.listdir(list_dir):
		...
		image_dir = "/tmp3/yuchen/BoAP_Adaboost/AVA_dataset/images"
...
if __name__ == '__main__':
	lost_image_url = get_dataset("/tmp3/yuchen/BoAP_Adaboost/AVA_dataset/AVA_dataset/aesthetics_image_lists")
